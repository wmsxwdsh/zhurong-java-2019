...
public class ZipUtil {
     ...
     * @param zipPath 压缩文件保存的路径。注意：
     * @param zipFileName 压缩文件名
     * @throws Exception
     */

    /**
     * @Description: 对文件或文件目录压缩成zip
     * @param srcPath 要压缩的源文件路径
     *      --如果压缩一个文件，则为该文件的全路径；如果压缩一个目录，则为该目录的顶层目录路径
     * @param zipPath 压缩文件保存的路径
     *      --zipPath不能是srcPath路径下的子文件夹
     *      --这个路径不存在也可以，不存在会创建
     *      --以下两种写法都可以：1、E:\hello\  2、 E：\hello
     * @param zipFileName 压缩包zip的文件名，如：hello.zip
     *      --后缀.zip不可省略
     * @return void
     * @author LZG
     * @date 2018/9/20
