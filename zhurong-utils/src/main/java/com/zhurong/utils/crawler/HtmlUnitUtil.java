/**
 * @Title: HtmlUnitUtil.java
 * @Package: com.zhurong.utils.crawler
...
/**
 * @description: HtmlUnit：爬虫工具&页面内容填充工具
 *      --教程参考：https://blog.csdn.net/wxl901018/article/details/44133873
 * @author LZG
 * @date 2018/9/26
 */
public class HtmlUnitUtil {
    ...
    /**
     * @Description: 根据URL和验证码ElementId获取图片的Base64编码
     * @param url 完整的url地址(支付https)
     * @param vCodeElementId 验证码ElementId(查看源码)
